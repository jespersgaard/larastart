...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">How To: Create a Page</div>
        <div class="panel-body">
            ...
            <p>So we need to open &quot;<em>app/Http/Controllers/PagesController.php</em>&quot; and add this following
                bit of code.</p>
            <code>
            ...
            <p>So we are going to need to create a new file called &quot;<em>example.blade.php</em>&quot; in the
                &quot;<em>resources/views/pages</em>&quot; directory.</p>
            ...
            <code>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div class="panel-heading">Our Example
                Page&lt;/div><br/>
